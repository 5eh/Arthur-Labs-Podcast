...
export function AudioPlayer() {
  ...
  return (
    <div className="flex items-center gap-6 bg-black px-4 py-4 shadow-sm ring-1 shadow-slate-200/80 ring-slate-900/5 backdrop-blur-xs md:px-6">
      ...
      <div className="mb-[env(safe-area-inset-bottom)] flex flex-1 flex-col gap-3 overflow-hidden p-1">
        <Link
          ...
          className="truncate text-center text-sm/6 font-bold text-gray-300 md:text-left"
