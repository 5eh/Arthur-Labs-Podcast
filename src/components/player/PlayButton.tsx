...
export function PlayButton({ player }: { player: PlayerAPI }) {
  ...
  return (
    <button
      type="button"
      className="group relative flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-black hover:bg-gray-200/10 focus:ring-2 focus:ring-slate-700 focus:ring-offset-2 focus:outline-hidden md:h-14 md:w-14"
